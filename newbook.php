...
?>
  <div id="main-container" class="container-fluid">
    <div class="offset-md-4 col-md-4 new-book-container">
      ...
      <form action="<?= $BASE_URL ?>book_process.php" id="add-book-form" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <textarea name="description" id="description" rows="5" class="form-control" placeholder="Descreva o Livro..."></textarea>
        </div>
